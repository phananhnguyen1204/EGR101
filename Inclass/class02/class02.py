...
# age=int(input('How old da u? '))
# location=input('Where do u live? ')
# location=location.lower()
# if location=='vietnam' and age<30:
#      print('qualified')
# else:
#      print('not qualified')
...
# elif mood=='sad':
#      eating_cakes=5
# print('Teacher Bear eats {0} cakes'.format(eating_cakes))
...
# print('I have two option')
# option=int(input('option1 or option2. Type your option: '))
